...
import (
	...
	_ "github.com/infinilabs/runtime-operator/pkg/builders/gateway"    // Trigger init() registration
	_ "github.com/infinilabs/runtime-operator/pkg/reconcilers/gateway" // Trigger init() registration for reconciler
...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "56afa202.infini.cloud",
